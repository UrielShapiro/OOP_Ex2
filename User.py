...
class User:
    """
    this class represents a network's user.
    """
    ...
    def follow(self, other_user: 'User'):
        """
        this func makes the user follow the other user.
    ...
    def unfollow(self, other_user):
        """
        this func removes the other user from the list of the users who followed by self.
    ...
    def log_out(self):
        """
        this func logs out the user (connected -> false)
        """
